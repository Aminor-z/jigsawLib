...
import com.aminor.civilizatus.world.gen.structure.jigsaw.piece.building.house_a.House_a_s_piece;
...
public class House_a_s implements IJigsawPattern {
    private static final House_a_s instance = new House_a_s();

    public static House_a_s getInstance() {
        return instance;
    }
    ...
    static {
        ...
        occupiedSectionPool.put(0,0,0, House_a_s_piece::getInstance);
        occupiedSectionPool.putSide(0,0,2,new JigsawSide().south(BUILDING_ENTRY));
        occupiedSectionPool.putSide(1,0,2,new JigsawSide().south(BUILDING_ENTRY));
        occupiedSectionPool.putSide(2,0,2,new JigsawSide().south(BUILDING_ENTRY));
    }

    static {
        //register summonNodeSocketPool here
        summonNodeSocketPool.register(0,0,2, SOUTH,JSNKT_BUILDING,10, House_a_s::getInstance);
        summonNodeSocketPool.register(1,0,2, SOUTH,JSNKT_BUILDING,10, House_a_s::getInstance);
        summonNodeSocketPool.register(2,0,2, SOUTH,JSNKT_BUILDING,10, House_a_s::getInstance);
    }
