...
import com.aminor.civilizatus.world.gen.structure.jigsaw.piece.plank_road.PlankRoad_EN_Piece;
...
public class PlankRoad_EN implements IJigsawPattern {
    private static final PlankRoad_EN instance = new PlankRoad_EN();
    ...
    static {
        ...
        occupiedSectionPool.put(0, 0, 0, PlankRoad_EN_Piece::getInstance);
    }

    static {
        //register summonNodeSocketPool here
        summonNodeSocketPool.register(0,0,0,EAST, JSNKT_PLANK_ROAD,2, PlankRoad_EN::getInstance);
        summonNodeSocketPool.register(0,0,0,NORTH, JSNKT_PLANK_ROAD,2, PlankRoad_EN::getInstance);

    }

    public static PlankRoad_EN getInstance() {
        return instance;
    }
