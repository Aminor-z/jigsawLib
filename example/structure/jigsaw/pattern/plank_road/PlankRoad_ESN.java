...
import com.aminor.civilizatus.world.gen.structure.jigsaw.piece.plank_road.PlankRoad_ESN_Piece;
...
public class PlankRoad_ESN implements IJigsawPattern {
    private static final PlankRoad_ESN instance = new PlankRoad_ESN();
    ...
    static {
        ...
        occupiedSectionPool.put(0, 0, 0, PlankRoad_ESN_Piece::getInstance);
    }

    static {
        //register summonNodeSocketPool here
        summonNodeSocketPool.register(0,0,0,EAST, JSNKT_PLANK_ROAD,1, PlankRoad_ESN::getInstance);
        summonNodeSocketPool.register(0,0,0,SOUTH, JSNKT_PLANK_ROAD,1, PlankRoad_ESN::getInstance);
        summonNodeSocketPool.register(0,0,0,NORTH, JSNKT_PLANK_ROAD,1, PlankRoad_ESN::getInstance);
    }

    public static PlankRoad_ESN getInstance() {
        return instance;
    }
