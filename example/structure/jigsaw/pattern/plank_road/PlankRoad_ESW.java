...
import com.aminor.civilizatus.world.gen.structure.jigsaw.piece.plank_road.PlankRoad_ESW_Piece;
...
public class PlankRoad_ESW implements IJigsawPattern {
    private static final PlankRoad_ESW instance = new PlankRoad_ESW();
    ...
    static {
        ...
        occupiedSectionPool.put(0, 0, 0, PlankRoad_ESW_Piece::getInstance);
    }

    static {
        //register summonNodeSocketPool here
        summonNodeSocketPool.register(0,0,0,EAST, JSNKT_PLANK_ROAD,1, PlankRoad_ESW::getInstance);
        summonNodeSocketPool.register(0,0,0,SOUTH, JSNKT_PLANK_ROAD,1, PlankRoad_ESW::getInstance);
        summonNodeSocketPool.register(0,0,0,WEST, JSNKT_PLANK_ROAD,1, PlankRoad_ESW::getInstance);
    }

    public static PlankRoad_ESW getInstance() {
        return instance;
    }
