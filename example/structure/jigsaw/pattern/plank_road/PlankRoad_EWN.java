...
import com.aminor.civilizatus.world.gen.structure.jigsaw.piece.plank_road.PlankRoad_EWN_Piece;
...
public class PlankRoad_EWN implements IJigsawPattern {
    private static final PlankRoad_EWN instance = new PlankRoad_EWN();
    ...
    static {
        ...
        occupiedSectionPool.put(0, 0, 0, PlankRoad_EWN_Piece::getInstance);
    }

    static {
        //register summonNodeSocketPool here
        summonNodeSocketPool.register(0,0,0,EAST, JSNKT_PLANK_ROAD,1, PlankRoad_EWN::getInstance);
        summonNodeSocketPool.register(0,0,0,WEST, JSNKT_PLANK_ROAD,1, PlankRoad_EWN::getInstance);
        summonNodeSocketPool.register(0,0,0,NORTH, JSNKT_PLANK_ROAD,1, PlankRoad_EWN::getInstance);
    }

    public static PlankRoad_EWN getInstance() {
        return instance;
    }
