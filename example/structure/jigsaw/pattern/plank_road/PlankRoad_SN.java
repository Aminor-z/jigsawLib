...
import com.aminor.civilizatus.world.gen.structure.jigsaw.piece.plank_road.PlankRoad_SN_Piece;
...
public class PlankRoad_SN implements IJigsawPattern {
    private static final PlankRoad_SN instance = new PlankRoad_SN();
    ...
    static {
        ...
        occupiedSectionPool.put(0, 0, 0, PlankRoad_SN_Piece::getInstance);
    }

    static {
        //register summonNodeSocketPool here
        summonNodeSocketPool.register(0,0,0,SOUTH, JSNKT_PLANK_ROAD,10, PlankRoad_SN::getInstance);
        summonNodeSocketPool.register(0,0,0,NORTH, JSNKT_PLANK_ROAD,10, PlankRoad_SN::getInstance);

    }

    public static PlankRoad_SN getInstance() {
        return instance;
    }
