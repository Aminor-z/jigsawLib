...
public class House_a_e_piece extends JigsawPiece {
    private static final House_a_e_piece instance = new House_a_e_piece();

    public static House_a_e_piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "building/house_a/e");
    ...
    public House_a_e_piece() {
        super(ISPT_House_a_e);
    }

    public House_a_e_piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_House_a_e, manager, pos);
    }

    public House_a_e_piece(TemplateManager manager, CompoundNBT nbt) {
