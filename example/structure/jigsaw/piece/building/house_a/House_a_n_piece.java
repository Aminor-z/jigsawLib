...
public class House_a_n_piece extends JigsawPiece {
    private static final House_a_n_piece instance = new House_a_n_piece();

    public static House_a_n_piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "building/house_a/n");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.north(BUILDING_ENTRY);
    }

    public House_a_n_piece() {
        super(ISPT_House_a_e);
    }

    public House_a_n_piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_House_a_e, manager, pos);
    }

    public House_a_n_piece(TemplateManager manager, CompoundNBT nbt) {
