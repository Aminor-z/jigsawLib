...
public class Shop_a_n_piece extends JigsawPiece {
    private static final Shop_a_n_piece instance = new Shop_a_n_piece();
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "building/shop_a/n");
    ...
    public Shop_a_n_piece() {
        super(SHOP_A_E_PIECE);
    }

    public Shop_a_n_piece(TemplateManager manager, BlockPos pos) {
        super(SHOP_A_E_PIECE, manager, pos);
    }

    public Shop_a_n_piece(TemplateManager manager, CompoundNBT nbt) {
        super(SHOP_A_E_PIECE, manager, nbt);
    }

    public static Shop_a_n_piece getInstance() {
        return instance;
    }
