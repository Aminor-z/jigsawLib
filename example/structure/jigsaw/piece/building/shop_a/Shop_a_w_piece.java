...
public class Shop_a_w_piece extends JigsawPiece {
    private static final Shop_a_w_piece instance = new Shop_a_w_piece();
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "building/shop_a/w");
    ...
    public Shop_a_w_piece() {
        super(SHOP_A_E_PIECE);
    }

    public Shop_a_w_piece(TemplateManager manager, BlockPos pos) {
        super(SHOP_A_E_PIECE, manager, pos);
    }

    public Shop_a_w_piece(TemplateManager manager, CompoundNBT nbt) {
        super(SHOP_A_E_PIECE, manager, nbt);
    }

    public static Shop_a_w_piece getInstance() {
        return instance;
    }
