...
public class PlankRoad_EN_Piece extends JigsawPiece {
    private static final PlankRoad_EN_Piece instance = new PlankRoad_EN_Piece();

    public static PlankRoad_EN_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/en");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD).south(PLANK_ROAD_DENY).west(PLANK_ROAD_DENY).north(PLANK_ROAD);
    }

    public PlankRoad_EN_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_EN_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_EN_Piece(TemplateManager manager, CompoundNBT nbt) {
