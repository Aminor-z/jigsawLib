...
public class PlankRoad_ESN_Piece extends JigsawPiece {
    private static final PlankRoad_ESN_Piece instance = new PlankRoad_ESN_Piece();

    public static PlankRoad_ESN_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/esn");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD).south(PLANK_ROAD).west(PLANK_ROAD_DENY).north(PLANK_ROAD);
    }

    public PlankRoad_ESN_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_ESN_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_ESN_Piece(TemplateManager manager, CompoundNBT nbt) {
