...
public class PlankRoad_ESW_Piece extends JigsawPiece {
    private static final PlankRoad_ESW_Piece instance = new PlankRoad_ESW_Piece();

    public static PlankRoad_ESW_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/esw");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD).south(PLANK_ROAD).west(PLANK_ROAD).north(PLANK_ROAD_DENY);
    }

    public PlankRoad_ESW_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_ESW_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_ESW_Piece(TemplateManager manager, CompoundNBT nbt) {
