...
public class PlankRoad_ES_Piece extends JigsawPiece {
    private static final PlankRoad_ES_Piece instance = new PlankRoad_ES_Piece();

    public static PlankRoad_ES_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/es");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD).south(PLANK_ROAD).west(PLANK_ROAD_DENY).north(PLANK_ROAD_DENY);
    }

    public PlankRoad_ES_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_ES_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_ES_Piece(TemplateManager manager, CompoundNBT nbt) {
