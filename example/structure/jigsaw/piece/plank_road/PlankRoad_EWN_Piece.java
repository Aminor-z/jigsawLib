...
public class PlankRoad_EWN_Piece extends JigsawPiece {
    private static final PlankRoad_EWN_Piece instance = new PlankRoad_EWN_Piece();

    public static PlankRoad_EWN_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/ewn");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD).south(PLANK_ROAD_DENY).west(PLANK_ROAD).north(PLANK_ROAD);
    }

    public PlankRoad_EWN_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_EWN_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_EWN_Piece(TemplateManager manager, CompoundNBT nbt) {
