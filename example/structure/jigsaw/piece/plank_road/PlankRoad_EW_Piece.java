...
public class PlankRoad_EW_Piece extends JigsawPiece {
    private static final PlankRoad_EW_Piece instance = new PlankRoad_EW_Piece();

    public static PlankRoad_EW_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/ew");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD).south(PLANK_ROAD_DENY).west(PLANK_ROAD).north(PLANK_ROAD_DENY);
    }

    public PlankRoad_EW_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_EW_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_EW_Piece(TemplateManager manager, CompoundNBT nbt) {
