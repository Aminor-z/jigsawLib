...
public class PlankRoad_SN_Piece extends JigsawPiece {
    private static final PlankRoad_SN_Piece instance = new PlankRoad_SN_Piece();

    public static PlankRoad_SN_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/sn");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD_DENY).south(PLANK_ROAD).west(PLANK_ROAD_DENY).north(PLANK_ROAD);
    }

    public PlankRoad_SN_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_SN_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_SN_Piece(TemplateManager manager, CompoundNBT nbt) {
