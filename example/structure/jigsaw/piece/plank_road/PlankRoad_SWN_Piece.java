...
public class PlankRoad_SWN_Piece extends JigsawPiece {
    private static final PlankRoad_SWN_Piece instance = new PlankRoad_SWN_Piece();

    public static PlankRoad_SWN_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/swn");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD_DENY).south(PLANK_ROAD).west(PLANK_ROAD).north(PLANK_ROAD);
    }

    public PlankRoad_SWN_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_SWN_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_SWN_Piece(TemplateManager manager, CompoundNBT nbt) {
