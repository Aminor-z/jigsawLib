...
public class PlankRoad_SW_Piece extends JigsawPiece {
    private static final PlankRoad_SW_Piece instance = new PlankRoad_SW_Piece();

    public static PlankRoad_SW_Piece getInstance() {
        return instance;
    }
    ...
    private static final ResourceLocation resourceLocation = new ResourceLocation("civilizatus", "plank_road/sw");
    private static JigsawSide jigsawSide = new JigsawSide();

    static {
        //register side type here
        jigsawSide.east(PLANK_ROAD_DENY).south(PLANK_ROAD).west(PLANK_ROAD).north(PLANK_ROAD_DENY);
    }

    public PlankRoad_SW_Piece() {
        super(ISPT_PlankRoad_EW);
    }

    public PlankRoad_SW_Piece(TemplateManager manager, BlockPos pos) {
        super(ISPT_PlankRoad_EW, manager, pos);
    }

    public PlankRoad_SW_Piece(TemplateManager manager, CompoundNBT nbt) {
