...
import static com.aminor.civilizatus.world.gen.structure.jigsaw.PieceRegister.ROAD_SN_COBBLESTONE;
import static com.aminor.civilizatus.world.gen.structure.jigsaw.Public_SideType.ROAD;

public class Road_SN_Cobblestone extends JigsawPiece {
    private static final Road_SN_Cobblestone instance=new Road_SN_Cobblestone();
    public static Road_SN_Cobblestone getInstance(){return instance;}
    //set your registered feature here
    private static final IStructurePieceType iStructurePieceType = ROAD_SN_COBBLESTONE;
    ...
    static {
        ...
        jigsawSide.south(ROAD).north(ROAD);
    }

    public Road_SN_Cobblestone() {
        super(ROAD_SN_COBBLESTONE);
    }

    public Road_SN_Cobblestone(TemplateManager manager, BlockPos pos) {
        super(ROAD_SN_COBBLESTONE, manager, pos);
    }

    public Road_SN_Cobblestone(TemplateManager manager, CompoundNBT nbt) {
        super(ROAD_SN_COBBLESTONE, manager, nbt);
    }
